...
ros::Publisher FirstPubScan, SecondPubScan;
ros::Publisher FirstPubObject, SecondPubObject;
...
int main (int argc, char** argv)
{
    ...
    std::string mInputTopic, mFirstOutputTopic, mSecondOutputTopic;
    std::string mInputObjectTopic, mFirstOutputObjectTopic, mSecondOutputObjectTopic;
    //Parameters
