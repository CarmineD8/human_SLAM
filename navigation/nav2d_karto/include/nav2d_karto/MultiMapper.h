...
private:
    ...
    karto::LocalizedObject* createObject(const karto::Identifier& robot);
    karto::CustomItem* createCustomerItem(const karto::Identifier& name);
    ...
    ros::Subscriber mCustomerSubscriber;
    ...
    std::string mObjectInputTopic;
    std::string mObjectOutputTopic;
    std::string mCustomInputTopic;
};
