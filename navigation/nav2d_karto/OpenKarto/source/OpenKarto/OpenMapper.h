...
namespace karto
{
  ...
  public:
     ...
     */
    kt_bool TryCloseLoop(LocalizedObject* pObject);
  ...
  public:
     ...
     * @return grid index is a scaler value, but in CorrelationGrid index is a vector (x,y)
     */
    ///In grid, Index is a
  ...
  protected:
    ...
    virtual void CalculateKernel()
    {
      ...
      /// calculate kernel
      ///hypoy -> return the square root of the 2 inputs
      kt_int32s halfKernel = m_KernelSize / 2;
  ...
  public:
    ...
    void ClearLastScan(const Identifier& rSensorName);
      /**
     * Gets last object of given sensor
     * @param rSensorName name of sensor
     * @return last localized object of sensor
     */
    LocalizedObject* GetLastObject(const Identifier& rSensorName);

      /**
       * Sets the last object of sensor to the given scan
       * @param pObject
       */
    void SetLastObject(LocalizedObject* pObject);

      /**
       * Resets the last object of the given sensor
       * @param rSensorName name of sensor
       */
    void ClearLastObject(const Identifier& rSensorName);
